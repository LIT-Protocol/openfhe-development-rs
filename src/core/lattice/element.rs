...
use num::traits::{ConstOne, ConstZero, FromPrimitive, NumOps, One, ToPrimitive, Zero};
use std::ops::{
    Add, AddAssign, BitAnd, BitAndAssign, BitOr, BitOrAssign, BitXor, BitXorAssign, Div, DivAssign,
    Index, Mul, MulAssign, Neg, Not, Rem, RemAssign, Shl, ShlAssign, Shr, ShrAssign, Sub,
    SubAssign,
};
    ...
    + for<'a> MulAssign<&'a Self>
{
    ...
    + Eq
    + PartialEq
    + Not<Output = Self::IntType>
    + Shl<usize, Output = Self::IntType>
    + ShlAssign<usize>
    + Shr<usize, Output = Self::IntType>
    + ShrAssign<usize>
    + BitAnd<Self::IntType, Output = Self::IntType>
    + BitAndAssign<Self::IntType>
    + BitOr<Self::IntType, Output = Self::IntType>
    + BitOrAssign<Self::IntType>
    + BitXor<Self::IntType, Output = Self::IntType>
    + BitXorAssign<Self::IntType>
    + ToPrimitive
    + FromPrimitive;
